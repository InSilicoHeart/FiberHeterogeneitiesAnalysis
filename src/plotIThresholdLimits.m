...
if(~isempty(dir([pathToSave '/status.mat'])))
    ...
    if(isfield(sim_stat,'minIStim') && isfield(sim_stat,'maxIStim'))
        ...
        a=load([pathToSave '/' Istim_str '/post/IThreshold_prc0_00000101.var']);
        b=load([pathToSave '/' Istim_str '/post/IThreshold_prc0_00000126.var']);
        c=load([pathToSave '/' Istim_str '/post/IThreshold_prc0_00000151.var']);
        d=load([pathToSave '/' Istim_str '/post/IThreshold_prc0_00000176.var']);
        e=load([pathToSave '/' Istim_str '/post/IThreshold_prc0_00000201.var']);
