function simulateSteadyState(pathToSave, params, range, numSim, nNodes, CL, nCLs, ...
...
parfor j=1:numSim
    ...
    pathSim = [pathSS '/Sim_' sprintf('%03d',j)]
    if(isempty(dir(pathSim)))
        ...
        createFileParamNode(pathSim,params,range,nNodes);
        cd(pathSim);
